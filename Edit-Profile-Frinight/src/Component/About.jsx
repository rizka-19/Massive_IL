...
const About = () => {
  const [aboutText, setAboutText] = useState(localStorage.getItem('aboutText') || "Lorem ipsum dolor sit amet consectetur. Suspendisse cursus ut ipsum tempor tempor. Risus eleifend diam tristique cras eu maecenas. Est sit bibendum nullam nunc pretium enim. Sit lorem turpis nisi imperdiet.");
